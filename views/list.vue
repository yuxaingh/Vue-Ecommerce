    ...
    <div v-show="list.length">
        <div class="list-control">
            ...
            <div class="list-control-order">
                ...
                @click="handleOrderSales">Sales
                <template v-if="order === 'sales'">desc</template>
                </span>
                <span class="list-control-order-item" :class="{on: order.indexOf('cost') > -1}"
                @click="handleOrderCost">Cost
                <template v-if="order === 'cost-asc'">asc</template>
                <template v-if="order === 'cost-desc'">des</template>
                </span>
            </div>
        </div>
